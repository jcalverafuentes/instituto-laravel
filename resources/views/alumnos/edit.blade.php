    ...
    <form action="{{ route('alumnos.update', $alumno->id) }}" method="POST" 
        ...
        <div class="mb-5">
            ...
            <input type="text" id="nombre" name="nombre" placeholder="Introduce tu nombre"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 
                       focus:ring-blue-400 focus:border-blue-400 outline-none" value="{{ $alumno->nombre }}">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="apellido" name="apellido" placeholder="Introduce tu apellido"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2
                       focus:ring-blue-400 focus:border-blue-400 outline-none" value="{{ $alumno->apellido }}">
                       <div class="text-red-500 text-sm">
        ...
        <div class="mb-5">
            ...
            <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 
                       focus:ring-blue-400 focus:border-blue-400 outline-none" value="{{ $alumno->fecha_nacimiento }}">
                       <div class="text-red-500 text-sm">
        ...
        <div class="mb-6">
            ...
            <input type="email" id="email" name="email" placeholder="Introduce tu email"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 
                       focus:ring-blue-400 focus:border-blue-400 outline-none" value="{{ $alumno->email }}">
                       <div class="text-red-500 text-sm">
                        {{ $errors->first('email') }}
                    </div>
        </div>
